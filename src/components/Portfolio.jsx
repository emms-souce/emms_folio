...
const Portfolio = () => {
  ...
  return (
    ...
    md:h-screen '>
      <div className='max-w-screen-lg px-4 mx-auto felx flex-col justify-cneter w-full h-full '>
        <div className='pb-8'>
        ...
        <div className='grid sm:gridcols-2 md:grid-cols-3  gap-8 px-12 sm:px-0'>
